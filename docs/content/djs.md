...
import Client, {
  updateEventHandlers,
} from "https://x.nest.land/Discordeno@9.0.0/src/module/client.ts";
...
import type { Message } from "https://x.nest.land/Discordeno@9.0.0/src/structures/message.ts";
import type { Command } from "./src/types/commands.ts";
import type { Guild } from "https://x.nest.land/Discordeno@9.0.0/src/structures/guild.ts";
...
import { configs } from "../../configs.ts";
import { cache } from "https://x.nest.land/Discordeno@9.0.0/src/utils/cache.ts";
import { editBotsStatus, chooseRandom } from "https://x.nest.land/Discordeno@9.0.0/src/utils/utils.ts";
import { StatusType } from "https://x.nest.land/Discordeno@9.0.0/src/types/discord.ts";
import { ActivityType } from "https://x.nest.land/Discordeno@9.0.0/src/types/activity.ts";
...
```ts
import { botCache } from "../../mod.ts";
import { addRole } from "https://x.nest.land/Discordeno@9.0.0/src/handlers/member.ts";
...
import type { Member } from "https://x.nest.land/Discordeno@9.0.0/src/structures/member.ts";
import { kick } from "https://x.nest.land/Discordeno@9.0.0/src/handlers/member.ts";
