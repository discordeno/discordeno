...
export const GUILD_DISCOVERY_CATEGORY = (guildID: BigString, categoryID: BigString) =>
...
export const INTERACTION_RESPOND = (interactID: BigString, interactToken: string) =>
...
export const GUILD_DISCOVERY_SPLASH = (guildID: BigString, guildDiscoverySplash: string) =>
