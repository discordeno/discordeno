...
export type ChatInputApplicationCommand = ApplicationCommand<Constants["ApplicationCommandTypes"]["CHAT_INPUT"]>;
...
export type ApplicationCommandOptionsBoolean = ApplicationCommandOption<Constants["ApplicationCommandOptionTypes"]["BOOLEAN"]>;
export type ApplicationCommandOptionsChannel = ApplicationCommandOption<Constants["ApplicationCommandOptionTypes"]["CHANNEL"]>;
...
export type ApplicationCommandOptionsIntegerWithAutocomplete =
  & Omit<
    ApplicationCommandOptionWithChoices<Constants["ApplicationCommandOptionTypes"]["INTEGER"]>,
    "choices" | "min_value" | "max_value"
  >
  & AutocompleteEnabled;
export type ApplicationCommandOptionsIntegerWithoutAutocomplete =
  & Omit<
    ApplicationCommandOptionWithChoices<Constants["ApplicationCommandOptionTypes"]["INTEGER"]>,
    "autocomplete" | "min_value" | "max_value"
  >
  & AutocompleteDisabledInteger;
export type ApplicationCommandOptionsIntegerWithMinMax =
  & Omit<
    ApplicationCommandOptionWithChoices<Constants["ApplicationCommandOptionTypes"]["INTEGER"]>,
    "choices" | "autocomplete"
  >
  & AutocompleteDisabledIntegerMinMax;
export type ApplicationCommandOptionsMentionable = ApplicationCommandOption<
...
export type ApplicationCommandOptionsNumberWithAutocomplete =
  & Omit<
    ApplicationCommandOptionWithChoices<Constants["ApplicationCommandOptionTypes"]["NUMBER"]>,
    "choices" | "min_value" | "max_value"
  >
  & AutocompleteEnabled;
export type ApplicationCommandOptionsNumberWithoutAutocomplete =
  & Omit<
    ApplicationCommandOptionWithChoices<Constants["ApplicationCommandOptionTypes"]["NUMBER"]>,
    "autocomplete" | "min_value" | "max_value"
  >
  & AutocompleteDisabledInteger;
export type ApplicationCommandOptionsNumberWithMinMax =
  & Omit<
    ApplicationCommandOptionWithChoices<Constants["ApplicationCommandOptionTypes"]["NUMBER"]>,
    "choices" | "autocomplete"
  >
  & AutocompleteDisabledIntegerMinMax;
export type ApplicationCommandOptionsRole = ApplicationCommandOption<Constants["ApplicationCommandOptionTypes"]["ROLE"]>;
...
export type ApplicationCommandOptionsStringWithAutocomplete =
  & Omit<ApplicationCommandOptionWithChoices<Constants["ApplicationCommandOptionTypes"]["STRING"]>, "choices">
  & AutocompleteEnabled;
export type ApplicationCommandOptionsStringWithoutAutocomplete =
  & Omit<ApplicationCommandOptionWithChoices<Constants["ApplicationCommandOptionTypes"]["STRING"]>, "autocomplete">
  & AutocompleteDisabled;
export type ApplicationCommandOptionsUser = ApplicationCommandOption<Constants["ApplicationCommandOptionTypes"]["USER"]>;
...
export type AnyGuildChannel = GuildTextableChannel | AnyVoiceChannel | CategoryChannel | StoreChannel;
export type AnyThreadChannel = NewsThreadChannel | PrivateThreadChannel | PublicThreadChannel | ThreadChannel;
...
> {
  channel_export types: T extends Constants["ApplicationCommandOptionTypes"]["CHANNEL"] ? ChannelTypes | undefined : never;
  description: string;
  name: string;
  required?: boolean;
  type: T;
...
export interface CreateThreadWithoutMessageOptions<T = AnyThreadChannel["export type"]> extends CreateThreadOptions {
  invitable: T extends PrivateThreadChannel["export type"] ? boolean : never;
  type: T;
}
