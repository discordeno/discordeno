...
export async function updateGuildCommands(bot: Bot, guildId: bigint): Promise<void> {
...
function createOptions(
  ...
  for (const option of options || []) {
    ...
    // @ts-expect-error choices does exist on the option
    ...
    newOptions.push({
      ...
      choices,
      // @ts-expect-error options does exist on the option
