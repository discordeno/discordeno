...
export function createCommand<T extends readonly ArgumentDefinition[]>(command: Command<T>): Command<T> {
  return command
}
  ...
  UnionToIntersection<
    {
      [P in keyof T]: T[P] extends StringOptionalArgumentDefinition<infer N> // STRING
        ? {
            [_ in getName<N>]?: T[P]['choices'] extends ReadonlyArray<{ name: string; value: string }>
        ...
        : T[P] extends StringArgumentDefinition<infer N>
          ...
          : // INTEGER
            ...
            ? {
                [_ in getName<N>]?: T[P]['choices'] extends ReadonlyArray<{ name: string; value: number }>
                  ? T[P]['choices'][number]['value']
                  : number
              }
                              ...
                              : // MENTIONABLE
                                ...
                                : T[P] extends MentionableArgumentDefinition<infer N>
                                  ...
                                  : // SUBCOMMAND
                                    ...
                                    ? {
                                        [_ in getName<N>]?: T[P]['options'] extends readonly ArgumentDefinition[]
