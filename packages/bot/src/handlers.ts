...
export function createBotGatewayHandlers<TProps extends TransformersDesiredProperties, TBehavior extends DesiredPropertiesBehavior>(
  ...
  return {
    ...
    CHANNEL_INFO: _options.CHANNEL_INFO ?? handlers.handleChannelInfo,
    ...
    VOICE_CHANNEL_START_TIME_UPDATE: _options.VOICE_CHANNEL_START_TIME_UPDATE ?? handlers.handleVoiceChannelStartTimeUpdate,
    VOICE_CHANNEL_STATUS_UPDATE: _options.VOICE_CHANNEL_STATUS_UPDATE ?? handlers.handleVoiceChannelStatusUpdate,
