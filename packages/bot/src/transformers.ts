import type {
  ...
  DiscordLobbyMember,
  DiscordLobbyMessage,
  DiscordLobbyMessageLobbyMember,
...
import {
  transformLobby,
  transformLobbyInvite,
  transformLobbyMember,
  transformLobbyMessage,
  transformLobbyMessageLobbyMember,
} from './transformers/lobby.js';
...
export type TransformerInformations = {
  ...
  lobbyMessageLobbyMember: TransformerInformation<DiscordLobbyMessageLobbyMember, LobbyMessageLobbyMember, true>;
...
export function createTransformers<TProps extends TransformersDesiredProperties, TBehavior extends DesiredPropertiesBehavior>(
  ...
  return {
    customizers: {
      ...
      lobbyMessageLobbyMember: _options.customizers?.lobbyMessageLobbyMember ?? defaultCustomizer,
    ...
    lobbyMessageLobbyMember: _options.lobbyMessageLobbyMember ?? transformLobbyMessageLobbyMember,
