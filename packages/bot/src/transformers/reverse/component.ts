...
export function transformComponentToDiscordComponent(bot: Bot, payload: Component): DiscordMessageComponent {
  ...
  //   style: payload.style ? payload.style : undefined,
  //   label: payload.label,
  //   emoji: payload.emoji
  //     ? {
  ...
  //   value: payload.value,
  //   // This casts to a button component, but this really is any component that can go in a actionRow
  //   components: payload.components?.map((component) => bot.transformers.reverse.component(bot, component)) as DiscordButtonComponent[],
