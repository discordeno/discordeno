import type { DiscordAuditLogEntry, DiscordGatewayPayload, DiscordGuildAuditLogEntryCreateExtra } from '@discordeno/types';
...
export async function handleGuildAuditLogEntryCreate(bot: Bot, data: DiscordGatewayPayload): Promise<void> {
  ...
  const payload = data.d as DiscordAuditLogEntry & DiscordGuildAuditLogEntryCreateExtra;
