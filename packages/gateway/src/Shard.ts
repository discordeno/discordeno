...
export class DiscordenoShard {
  ...
  async handleDiscordPacket(packet: DiscordGatewayPayload): Promise<void> {
    ...
    switch (packet.op) {
      ...
      case GatewayOpcodes.InvalidSession: {
        ...
        // Reference: https://docs.discord.com/developers/topics/gateway#resuming
  ...
  startHeartbeating(interval: number): void {
    ...
    // Reference: https://docs.discord.com/developers/topics/gateway#heartbeating
    ...
    this.heart.timeoutId = setTimeout(() => {
      ...
      this.heart.intervalId = setInterval(async () => {
        ...
        // Reference: https://docs.discord.com/developers/topics/gateway#heartbeating-example-gateway-heartbeat-ack
