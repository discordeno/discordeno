...
export function transformInviteCreate(bot: Bot, invite: DiscordInviteCreate) {
  const inviteCreate = {
  ...
  return inviteCreate as Optionalize<typeof inviteCreate>;
}

export interface InviteCreate extends ReturnType<typeof transformInviteCreate> {}
