...
import ReactFlow, { Background, Controls, Edge, Handle, Node, NodeMouseHandler, Position, useEdgesState, useNodesState } from 'reactflow'
...
const handlers: {
  ...
  handleThreadListSync: {
    transformers: ['transformers.snowflake', 'transformers.snowflake', 'transformers.channel', 'transformers.snowflake', 'transformers.snowflake'],
    event: undefined,
  },
  handleThreadMembersUpdate: {
    transformers: ['transformers.snowflake', 'transformers.snowflake', 'transformers.threadMember', 'transformers.snowflake'],
  ...
  handleMessageDeleteBulk: {
    transformers: ['transformers.snowflake', 'transformers.snowflake', 'transformers.snowflake', 'transformers.snowflake', 'transformers.snowflake'],
  ...
  handleMessageReactionRemove: {
    transformers: ['transformers.snowflake', 'transformers.snowflake', 'transformers.snowflake', 'transformers.snowflake', 'transformers.emoji'],
  ...
  handleMessageReactionRemoveEmoji: {
    transformers: ['transformers.snowflake', 'transformers.snowflake', 'transformers.snowflake', 'transformers.emoji'],
  ...
  handleReady: {
    transformers: ['transformers.user', 'transformers.snowflake', 'transformers.snowflake', 'transformers.snowflake', 'transformers.snowflake'],
    event: 'events.ready',
  },
  handleTypingStart: {
    transformers: ['transformers.snowflake', 'transformers.snowflake', 'transformers.snowflake', 'transformers.member'],
...
export default function FlowChart({ handlerFilter = (handler: string) => true }) {
  ...
  for (const [index, handler] of Object.keys(handlers).filter(handlerFilter).entries()) {
    initialNodes.push({
      ...
      position: {
        x: 2 * multiplier,
        y: index * (height + 10) - Object.keys(handlers).filter(handlerFilter).length * ((height + 10) / 2) + height / 2,
      },
          ...
          nodeTypes={{
            baseLineNode: () => (
              <div style={{ height: '1px', width: '20px' }}>
                <Handle type="target" position={Position.Bottom} style={{ background: 'rgba(0,0,0,0)', borderColor: 'rgba(0,0,0,0)' }} />
                <Handle type="source" position={Position.Top} style={{ background: 'rgba(0,0,0,0)', borderColor: 'rgba(0,0,0,0)' }} />
              </div>
            ),
            baseLineNodeText: (n) => (
