...
In addition, the handling of errors generated by the user is very important to increase transparency. If the user doesn't know why the error happened, thet will be very surprised what they did wrong and could even remove your bot.
