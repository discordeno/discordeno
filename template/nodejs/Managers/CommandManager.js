...
class CommandManager {
    ...
    async onInteraction(interaction) {
        ...
        const messagecommand = new command({ manager: this, interaction: interaction, client: this.client, args: args, settings: {}, commandName: command.name });
        messagecommand.execute()?.catch?.((error) => {
            console.log(error);
            // Call Function on CommandResponse.js, handle the error
            return messagecommand.onError((error ?? 'custom'))
